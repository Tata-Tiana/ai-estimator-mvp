...
DERIVED_PRICE_ROWS = [
    ...
    },
    {
        ...
        "name": "Утепление стен ЭППС 50мм, работа",
        "unit": "м2",
        "min_quantity": 1,
        "price": 500,
        "price_code": "eps_wall_insulation_work_50_m2",
        "comment": "ИСПРАВЛЕНО 2026-08-08 (ответ Елены на вопрос от 2026-08-06): это не 'один проход на оба слоя' - работа утепления не зависит от толщины плиты ЭППС, ставка за м2 одинаковая что для 50мм, что для 100мм слоя (это разные площади/конструкции, не два слоя друг на друге). Раньше стояло 0 из опасения задвоить деньги поверх ставки 100мм-слоя - опасение снято, задвоения нет, т.к. 50мм и 100мм всегда считаются по СВОИМ отдельным площадям. Ставка = eps_wall_insulation_work_m2 (500 руб./м2).",
    },
    {
        "section": "Кровля",
