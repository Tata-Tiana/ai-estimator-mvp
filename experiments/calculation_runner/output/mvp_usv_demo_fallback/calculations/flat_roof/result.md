...
| --- | --- | --- | ---: | ---: | --- |
| totals | `internal_materials_total_raw` | `internal_materials_total_raw` | 1420802 | 1417243.508576 | mismatch |
| totals | `internal_materials_total` | `internal_materials_total` | 1420802 | 1417244 | mismatch |
| totals | `internal_works_total_raw` | `internal_works_total_raw` | 618070 | 618070.04 | mismatch |
| totals | `internal_works_total` | `internal_works_total` | 618070 | 618070 | ok |
| totals | `internal_section_total_raw` | `internal_section_total_raw` | 2038872 | 2035313.548576 | mismatch |
| totals | `internal_section_total` | `internal_section_total` | 2038872 | 2035314 | mismatch |
| totals | `sum_of_displayed_line_material_totals` | `sum_of_displayed_line_material_totals` | 1420802 | 1417244 | mismatch |
| totals | `sum_of_displayed_line_work_totals` | `sum_of_displayed_line_work_totals` | 618070 | 618070 | ok |
| totals | `sum_of_displayed_line_totals` | `sum_of_displayed_line_totals` | 2038872 | 2035314 | mismatch |
...
| estimate_lines | `vapor_barrier_film_technonikol_120mk` | `internal_cost.material_unit_price` | 35 | 23.12 | mismatch |
| estimate_lines | `vapor_barrier_film_technonikol_120mk` | `internal_cost.material_total_raw` | 10500 | 6936 | mismatch |
| estimate_lines | `vapor_barrier_film_technonikol_120mk` | `internal_cost.material_total` | 10500 | 6936 | mismatch |
...
| estimate_lines | `vapor_barrier_film_technonikol_120mk` | `internal_cost.line_total_raw` | 10500 | 6936 | mismatch |
| estimate_lines | `vapor_barrier_film_technonikol_120mk` | `internal_cost.line_total` | 10500 | 6936 | mismatch |
...
| estimate_lines | `eps100_technonikol_carbon_eco` | `internal_cost.material_total` | 377080 | 377082 | mismatch |
...
| estimate_lines | `eps100_technonikol_carbon_eco` | `internal_cost.line_total` | 377080 | 377082 | mismatch |
...
| estimate_lines | `eps_slope_2_1_plate_a` | `internal_cost.material_total` | 41304 | 41305 | mismatch |
...
| estimate_lines | `eps_slope_2_1_plate_a` | `internal_cost.line_total` | 41304 | 41305 | mismatch |
...
| estimate_lines | `pvc_membrane_logicroof_vrp_1_5mm_gray` | `internal_cost.material_total` | 565738 | 565741 | mismatch |
...
| estimate_lines | `pvc_membrane_logicroof_vrp_1_5mm_gray` | `internal_cost.line_total` | 565738 | 565741 | mismatch |
