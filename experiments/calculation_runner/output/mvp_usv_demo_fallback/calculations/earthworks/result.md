# Расчёт земляных работ: earthworks
...
| `geotextile_with_overlap_m2` | `352.0` |
| `geotextile_rolls` | `4` |
...
| `volumes.geotextile_with_overlap_m2` | `363.0` | `352.0` | `-11.0` | `mismatch` |
...
| `estimate_lines.axis_marking.work_unit_price` | `20000` | `20000.0` | `0.0` | `ok` |
...
| `estimate_lines.excavator_jcb.material_unit_price` | `26000` | `26000.0` | `0.0` | `ok` |
...
| `estimate_lines.excavator_jcb.line_total` | `88500` | `78000` | `-10500` | `mismatch` |
...
| `estimate_lines.manual_excavation.work_unit_price` | `1400` | `1400.0` | `0.0` | `ok` |
...
| `estimate_lines.geotextile_laying.work_unit_price` | `35` | `35.0` | `0.0` | `ok` |
...
| `estimate_lines.geotextile_material.material_unit_price` | `109` | `4562.0` | `4453.0` | `mismatch` |
| `estimate_lines.geotextile_material.material_total` | `43600` | `1824800` | `1781200` | `mismatch` |
| `estimate_lines.geotextile_material.work_unit_price` | `0` | `0.0` | `0.0` | `ok` |
| `estimate_lines.geotextile_material.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.geotextile_material.line_total` | `43600` | `1824800` | `1781200` | `mismatch` |
...
| `estimate_lines.sand_filling.work_unit_price` | `1200` | `1200.0` | `0.0` | `ok` |
...
| `estimate_lines.sand_material.material_unit_price` | `1550` | `1550.0` | `0.0` | `ok` |
...
| `estimate_lines.communications_work.work_unit_price` | `350` | `350.0` | `0.0` | `ok` |
...
| `estimate_lines.communications_material.material_unit_price` | `650` | `650.0` | `0.0` | `ok` |
...
| `internal_totals.internal_materials_total` | `467797` | `2248997` | `1781200` | `mismatch` |
| `internal_totals.internal_works_total` | `337223` | `337223` | `0` | `ok` |
| `internal_totals.internal_section_total` | `805020` | `2586220` | `1781200` | `mismatch` |
