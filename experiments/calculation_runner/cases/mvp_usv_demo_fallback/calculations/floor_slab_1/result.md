# Расчёт монолитной плиты перекрытия 1-го этажа: floor_slab_1
...
| `beams.items` | `[{"code": "beam_b1", "name": "Б-1", "length_m": 7.0, "width_m": 0.3, "height_m": 0.25, "concrete_volume_m3": 0.525, "formwork_area_m2": 5.6}, {"code": "beam_b2", "name": "Б-2", "length_m": 7.2, "width_m": 0.3, "height_m": 0.68, "concrete_volume_m3": 1.4688, "formwork_area_m2": 11.952}, {"code": "beam_b3", "name": "Б-3", "length_m": 9.0, "width_m": 0.3, "height_m": 0.43, "concrete_volume_m3": 1.161, "formwork_area_m2": 10.44}]` |
...
| `formwork.excel_rate_per_m2` | `600` |
...
| `rebar.items` | `[{"code": "rebar_a500_d25", "name": "Арматура класса А500 диаметром 25 мм", "steel_class": "A500", "diameter_mm": 25, "source_weight_kg": 162.0, "kg_per_meter": 3.85, "base_length_m": 42.077922, "waste_coeff": 1.05, "length_with_waste_m": 44.181818, "weight_with_waste_kg_display": 170.1, "rod_length_m": 11.7, "rods_ordered": 4, "order_length_m": 46.8, "unit_price_per_m": 196.35, "material_total_raw": 9189.18, "material_total": 9189}, {"code": "rebar_a500_d16", "name": "Арматура класса А500 диаметром 16 мм", "steel_class": "A500", "diameter_mm": 16, "source_weight_kg": 112.04, "kg_per_meter": 1.58, "base_length_m": 70.911392, "waste_coeff": 1.05, "length_with_waste_m": 74.456962, "weight_with_waste_kg_display": 117.64, "rod_length_m": 11.7, "rods_ordered": 7, "order_length_m": 81.9, "unit_price_per_m": 80.58, "material_total_raw": 6599.502, "material_total": 6600}, {"code": "rebar_a500_d12", "name": "Арматура класса А500 диаметром 12 мм", "steel_class": "A500", "diameter_mm": 12, "source_weight_kg": 42.0, "kg_per_meter": 0.888, "base_length_m": 47.297297, "waste_coeff": 1.05, "length_with_waste_m": 49.662162, "weight_with_waste_kg_display": 44.1, "rod_length_m": 11.7, "rods_ordered": 5, "order_length_m": 58.5, "unit_price_per_m": 45.29, "material_total_raw": 2649.465, "material_total": 2649}, {"code": "rebar_a500_d10", "name": "Арматура класса А500 диаметром 10 мм", "steel_class": "A500", "diameter_mm": 10, "source_weight_kg": 4038.6, "kg_per_meter": 0.617, "base_length_m": 6545.54295, "waste_coeff": 1.05, "length_with_waste_m": 6872.820097, "weight_with_waste_kg_display": 4240.53, "rod_length_m": 11.7, "rods_ordered": 588, "order_length_m": 6879.6, "unit_price_per_m": 32.72, "material_total_raw": 225100.512, "material_total": 225101}, {"code": "rebar_a240_d8", "name": "Арматура класса А240 диаметром 8 мм", "steel_class": "A240", "diameter_mm": 8, "source_weight_kg": 17.0, "kg_per_meter": 0.395, "base_length_m": 43.037975, "waste_coeff": 1.05, "length_with_waste_m": 45.189873, "weight_with_waste_kg_display": 17.85, "rod_length_m": 6.0, "rods_ordered": 8, "order_length_m": 48.0, "unit_price_per_m": 24.0, "material_total_raw": 1152.0, "material_total": 1152}, {"code": "rebar_a240_d6", "name": "Арматура класса А240 диаметром 6 мм", "steel_class": "A240", "diameter_mm": 6, "source_weight_kg": 38.0, "kg_per_meter": 0.222, "base_length_m": 171.171171, "waste_coeff": 1.05, "length_with_waste_m": 179.72973, "weight_with_waste_kg_display": 39.9, "rod_length_m": 6.0, "rods_ordered": 30, "order_length_m": 180.0, "unit_price_per_m": 13.32, "material_total_raw": 2397.6, "material_total": 2398}]` |
...
| `rebar.max_weight_per_truck_kg` | `10000` |
...
- `formwork_delivery_return_manipulator`: <=150 м2: 1 привоз + 1 вывоз; >180 м2: 2 привоз + 2 вывоз; 150-180 м2: manual_review.
...
- `rebar_metal_delivery`: В будущем box_calculator доставка металла должна считаться один раз по общему весу металла коробки.
...
| --- | ---: | ---: | ---: | --- |
| `totals.internal_materials_total` | `1175601` | `1132538` | `-43063` | `mismatch` |
| `totals.internal_works_total` | `611926` | `611926` | `0` | `ok` |
| `totals.internal_section_total` | `1787527` | `1744464` | `-43063` | `mismatch` |
| `totals.base_subtotal_raw_before_overheads` | `1713968.300518` | `1713968.300518` | `0.0` | `ok` |
| `totals.logistics_and_supply_total` | `17140` | `17140` | `0` | `ok` |
| `totals.consumables_and_tool_depreciation_total` | `51419` | `51419` | `0` | `ok` |
...
| `calculation_blocks.formwork.raw_average_rate` | `589.5903847` | `589.5903847` | `0.0` | `ok` |
...
| `calculation_blocks.rebar.total_delivery_weight_kg_raw` | `6455.49` | `6455.49` | `0.0` | `ok` |
| `calculation_blocks.rebar.total_delivery_weight_kg_display` | `6456` | `6456` | `0` | `ok` |
| `calculation_blocks.rebar.trucks_ordered` | `1` | `1` | `0` | `ok` |
...
| `calculation_blocks.overheads.base_subtotal_raw_before_overheads` | `1713968.300518` | `1713968.300518` | `0.0` | `ok` |
| `calculation_blocks.overheads.logistics_and_supply_total` | `17140` | `17140` | `0` | `ok` |
| `calculation_blocks.overheads.consumables_and_tool_depreciation_total` | `51419` | `51419` | `0` | `ok` |
...
| `estimate_lines.rebar_a500_d25.material_total_raw` | `9189.18` | `7291.44` | `-1897.74` | `mismatch` |
| `estimate_lines.rebar_a500_d25.material_total` | `9189` | `7291` | `-1898` | `mismatch` |
| `estimate_lines.rebar_a500_d25.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.rebar_a500_d25.line_total` | `9189` | `7291` | `-1898` | `mismatch` |
...
| `estimate_lines.rebar_a500_d16.material_total_raw` | `6599.502` | `5315.31` | `-1284.192` | `mismatch` |
| `estimate_lines.rebar_a500_d16.material_total` | `6600` | `5315` | `-1285` | `mismatch` |
| `estimate_lines.rebar_a500_d16.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.rebar_a500_d16.line_total` | `6600` | `5315` | `-1285` | `mismatch` |
...
| `estimate_lines.rebar_a500_d12.material_total_raw` | `2649.465` | `2155.725` | `-493.74` | `mismatch` |
| `estimate_lines.rebar_a500_d12.material_total` | `2649` | `2156` | `-493` | `mismatch` |
| `estimate_lines.rebar_a500_d12.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.rebar_a500_d12.line_total` | `2649` | `2156` | `-493` | `mismatch` |
...
| `estimate_lines.rebar_a500_d10.material_total_raw` | `225100.512` | `186849.936` | `-38250.576` | `mismatch` |
| `estimate_lines.rebar_a500_d10.material_total` | `225101` | `186850` | `-38251` | `mismatch` |
| `estimate_lines.rebar_a500_d10.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.rebar_a500_d10.line_total` | `225101` | `186850` | `-38251` | `mismatch` |
| `estimate_lines.rebar_a240_d8.quantity_raw` | `48` | `48.0` | `0.0` | `ok` |
| `estimate_lines.rebar_a240_d8.quantity_display` | `48` | `48.0` | `0.0` | `ok` |
| `estimate_lines.rebar_a240_d8.material_total` | `1152` | `888` | `-264` | `mismatch` |
| `estimate_lines.rebar_a240_d8.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.rebar_a240_d8.line_total` | `1152` | `888` | `-264` | `mismatch` |
| `estimate_lines.rebar_a240_d6.quantity_raw` | `180` | `180.0` | `0.0` | `ok` |
| `estimate_lines.rebar_a240_d6.quantity_display` | `180` | `180.0` | `0.0` | `ok` |
| `estimate_lines.rebar_a240_d6.material_total_raw` | `2397.6` | `1845.0` | `-552.6` | `mismatch` |
| `estimate_lines.rebar_a240_d6.material_total` | `2398` | `1845` | `-553` | `mismatch` |
| `estimate_lines.rebar_a240_d6.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.rebar_a240_d6.line_total` | `2398` | `1845` | `-553` | `mismatch` |
| `estimate_lines.rebar_metal_delivery.quantity_raw` | `1` | `1.0` | `0.0` | `ok` |
| `estimate_lines.rebar_metal_delivery.quantity_display` | `1` | `1.0` | `0.0` | `ok` |
...
| `estimate_lines.eps_glue_foam.material_total` | `3920` | `3600` | `-320` | `mismatch` |
| `estimate_lines.eps_glue_foam.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.eps_glue_foam.line_total` | `3920` | `3600` | `-320` | `mismatch` |
...
| `estimate_lines.logistics_and_supply.material_total_raw` | `17139.683005` | `17139.683005` | `0.0` | `ok` |
| `estimate_lines.logistics_and_supply.material_total` | `17140` | `17140` | `0` | `ok` |
| `estimate_lines.logistics_and_supply.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.logistics_and_supply.line_total` | `17140` | `17140` | `0` | `ok` |
...
| `estimate_lines.consumables_tool_depreciation.material_total_raw` | `51419.049016` | `51419.049016` | `0.0` | `ok` |
| `estimate_lines.consumables_tool_depreciation.material_total` | `51419` | `51419` | `0` | `ok` |
| `estimate_lines.consumables_tool_depreciation.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.consumables_tool_depreciation.line_total` | `51419` | `51419` | `0` | `ok` |
