# Расчёт несущих стен и перемычек: load_bearing_walls_lintels
...
| `estimate_lines.main_wall_rebar_a500_d10.material_total_raw` | `37133.928` | `30823.884` | `-6310.044` | `mismatch` |
| `estimate_lines.main_wall_rebar_a500_d10.material_total` | `37134` | `30824` | `-6310` | `mismatch` |
| `estimate_lines.main_wall_rebar_a500_d10.line_total` | `37134` | `30824` | `-6310` | `mismatch` |
...
| `estimate_lines.lintel_rebar_a500_d12.material_total_raw` | `5828.823` | `4742.595` | `-1086.228` | `mismatch` |
| `estimate_lines.lintel_rebar_a500_d12.material_total` | `5829` | `4743` | `-1086` | `mismatch` |
| `estimate_lines.lintel_rebar_a240_d6.quantity` | `102` | `102.0` | `0.0` | `ok` |
| `estimate_lines.lintel_rebar_a240_d6.material_total_raw` | `1358.64` | `1045.5` | `-313.14` | `mismatch` |
| `estimate_lines.lintel_rebar_a240_d6.material_total` | `1359` | `1046` | `-313` | `mismatch` |
...
| `estimate_lines.vent_chimney_gas_block_cladding_work.work_total_raw` | `13760` | `13760.04` | `0.04` | `mismatch` |
...
| `estimate_lines.parapet_and_second_light_rebar_a500_d10.material_total_raw` | `13398.84` | `11122.02` | `-2276.82` | `mismatch` |
| `estimate_lines.parapet_and_second_light_rebar_a500_d10.material_total` | `13399` | `11122` | `-2277` | `mismatch` |
...
| `internal_totals.internal_materials_total_raw` | `1550654.431` | `1540668.199` | `` | `mismatch` |
| `internal_totals.internal_materials_total` | `1550654` | `1540668` | `-9986` | `mismatch` |
| `internal_totals.internal_works_total_raw` | `1121449` | `1121449.04` | `` | `mismatch` |
| `internal_totals.internal_works_total` | `1121449` | `1121449` | `0` | `ok` |
| `internal_totals.internal_section_total_raw` | `2672103.431` | `2662117.239` | `` | `mismatch` |
| `internal_totals.internal_section_total` | `2672103` | `2662117` | `-9986` | `mismatch` |
| `internal_totals.sum_of_displayed_line_material_totals` | `1550656` | `1540670` | `-9986` | `mismatch` |
| `internal_totals.sum_of_displayed_line_work_totals` | `1121449` | `1121449` | `0` | `ok` |
| `internal_totals.sum_of_displayed_line_totals` | `2672105` | `2662119` | `-9986` | `mismatch` |
