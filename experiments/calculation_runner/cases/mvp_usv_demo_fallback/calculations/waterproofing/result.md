# Расчёт гидроизоляции фундаментной плиты: waterproofing
...
| `calculation_blocks.waterproofing.waterproofing_base_subtotal` | `48777` | `46799` | `-1978` | `mismatch` |
| `calculation_blocks.waterproofing.logistics_amount_raw` | `975.54` | `935.98` | `-39.56` | `mismatch` |
| `calculation_blocks.waterproofing.consumables_amount_raw` | `1463.31` | `1403.97` | `-59.34` | `mismatch` |
...
| `estimate_lines.bitumen_primer_aquamast_18l.material_total` | `2770` | `2865` | `95` | `mismatch` |
| `estimate_lines.bitumen_primer_aquamast_18l.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.bitumen_primer_aquamast_18l.line_total` | `2770` | `2865` | `95` | `mismatch` |
| `estimate_lines.bitumen_mastic_aquamast_18kg.quantity` | `3` | `3.0` | `0.0` | `ok` |
| `estimate_lines.bitumen_mastic_aquamast_18kg.material_total` | `8340` | `8485` | `145` | `mismatch` |
| `estimate_lines.bitumen_mastic_aquamast_18kg.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.bitumen_mastic_aquamast_18kg.line_total` | `8340` | `8485` | `145` | `mismatch` |
...
| `estimate_lines.eps100_wall_penoplex_geo_material.material_total` | `19432` | `17294` | `-2138` | `mismatch` |
| `estimate_lines.eps100_wall_penoplex_geo_material.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.eps100_wall_penoplex_geo_material.line_total` | `19432` | `17294` | `-2138` | `mismatch` |
| `estimate_lines.eps_glue_foam.quantity` | `2` | `2.0` | `0.0` | `ok` |
| `estimate_lines.eps_glue_foam.material_total` | `980` | `900` | `-80` | `mismatch` |
| `estimate_lines.eps_glue_foam.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.eps_glue_foam.line_total` | `980` | `900` | `-80` | `mismatch` |
| `estimate_lines.waterproofing_logistics_and_supply.quantity` | `1` | `1.0` | `0.0` | `ok` |
| `estimate_lines.waterproofing_logistics_and_supply.material_total` | `976` | `936` | `-40` | `mismatch` |
| `estimate_lines.waterproofing_logistics_and_supply.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.waterproofing_logistics_and_supply.line_total` | `976` | `936` | `-40` | `mismatch` |
| `estimate_lines.waterproofing_consumables_tool_amortization.quantity` | `1` | `1.0` | `0.0` | `ok` |
| `estimate_lines.waterproofing_consumables_tool_amortization.material_total` | `1463` | `1404` | `-59` | `mismatch` |
| `estimate_lines.waterproofing_consumables_tool_amortization.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.waterproofing_consumables_tool_amortization.line_total` | `1463` | `1404` | `-59` | `mismatch` |
| `internal_totals.waterproofing_base_subtotal` | `48777` | `46799` | `-1978` | `mismatch` |
| `internal_totals.internal_materials_total` | `33961` | `31884` | `-2077` | `mismatch` |
| `internal_totals.internal_works_total` | `17255` | `17255` | `0` | `ok` |
| `internal_totals.internal_section_total` | `51216` | `49139` | `-2077` | `mismatch` |
