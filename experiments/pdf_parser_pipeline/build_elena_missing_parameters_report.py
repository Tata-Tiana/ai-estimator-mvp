...
RU_LABELS = {
    ...
    "slab_side_formwork_area_m2": "Площадь опалубки бортов фундаментной плиты по спецификации",
    ...
    "thermal_insert_50_length_m": "Длина термовставок 50 мм по спецификации",
    "thermal_insert_100_length_m": "Длина термовставок 100 мм по спецификации",
    ...
    "thermal_insert_material_waste_coeff": "Коэффициент запаса материала термовставок",
    "thermal_insert_50_pack_multiple_qty": "Кратность упаковки материала термовставок 50 мм",
    "thermal_insert_100_pack_multiple_qty": "Кратность упаковки материала термовставок 100 мм",
