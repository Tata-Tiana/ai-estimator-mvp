...
| 17 | `formwork_dismantling_control` | Демонтаж опалубки после завершения бетонирования | м2 | 180.01 | 180.01 | 0 | 0 | 0 |
...
| 21 | `logistics_and_supply` | Логистика, и снабжение | - | 1 | 1 | 8 291 | 0 | 8 291 |
| 22 | `consumables_tool_depreciation` | Расходные материалы, амортизация инструмента | комплект | 1 | 1 | 24 872 | 0 | 24 872 |
