# Ж/Б МОНОЛИТНАЯ ПЛИТА ПЕРЕКРЫТИЯ 2-го этажа

## Inputs

- project_name: `test_floor_slab_2_edge_and_beam_formwork_combined`
- slab_area_m2: `None`
...
- edge_beam_formwork_area_for_materials_m2: `12.92`
- calculated_edge_formwork_area_m2: `None`
- edge_formwork_area_delta_m2: `None`
- edge_formwork_area_source: `spec_formwork_area_combined_edge_and_beam`
- formwork_delivery_calc_method: `area_threshold`
...
- beams_bottom_formwork_area_m2: `0.0`
- edge_beam_formwork_area_for_materials_m2: `12.92`
- edge_plywood_sheets_raw: `5.617391`
- non_multiple_places_area_m2: `18.8`
- non_multiple_places_plywood_sheets_raw: `8.173913`
- base_plywood_sheets_raw: `13.791304`
- order_plywood_sheets_raw: `18.791304`
- plywood_sheets: `19`
- timber_volume_m3_raw: `0.646`
- timber_volume_m3_display: `0.65`
...
- direct_cost_base_before_addons_raw: `686165.502`
- logistics_rate: `0.01`
- logistics_total_raw: `6861.65502`
- consumables_rate: `0.03`
- consumables_total_raw: `20584.96506`
...
| 6 | `formwork_consumables` | Расходные материалы для установки опалубки (смазка; звездочки ПВХ, трубки) | - | 1 | 1 | 4 418 | 0 | 4 418 |
| 7 | `edge_formwork_installation_control` | Монтаж опалубки из доски 50 мм и фанеры для устройства балок и отбортовки плиты | м2 | 12.92 | 12.92 | 0 | 0 | 0 |
| 8 | `plywood_for_edges` | Фанера ФК 1,52 * 1,52 толщиной 18 мм для закрытия некратных мест и торцов | шт | 19 | 19 | 27 550 | 0 | 27 550 |
| 9 | `timber_for_formwork` | Пиломатериал обрезной для устройства опалубки ГОСТ | м3 | 0.65 | 0.65 | 13 889 | 0 | 13 889 |
| 10 | `rebar_frame_assembly_control` | Изготовление и монтаж каркаса армирования монолитного перекрытия из арматуры | мп | 1 263.6 | 1 263.6 | 0 | 0 | 0 |
| 11 | `rebar_a500_d16` | Арматура класса А500 диаметром 16 мм | мп | 70.2 | 70.2 | 5 657 | 0 | 5 657 |
| 12 | `rebar_a500_d10` | Арматура класса А500 диаметром 10 мм | мп | 1 193.4 | 1 193.4 | 39 048 | 0 | 39 048 |
| 13 | `concrete_placing_work` | Бетонирование монолитной плиты перекрытия бетоном марки В22,5 (М300) | м3 | 17.5 | 17.5 | 0 | 210 000 | 210 000 |
| 14 | `beam_concreting_work` | Бетонирование балки бетоном марки В22,5 (М300) | мп | 0 | 0 | 0 | 0 | 0 |
| 15 | `concrete_b22_5_m300_material` | Бетон марки В22,5 (М300) | м3 | 18.5 | 18.5 | 118 400 | 0 | 118 400 |
| 16 | `concrete_delivery` | Доставка бетона до объекта | рейс | 3 | 3 | 22 500 | 0 | 22 500 |
...
| 23 | `logistics_and_supply` | Логистика, и снабжение | - | 1 | 1 | 6 862 | 0 | 6 862 |
| 24 | `consumables_tool_depreciation` | Расходные материалы, амортизация инструмента | комплект | 1 | 1 | 20 585 | 0 | 20 585 |
...
- Тип строки: `zero_excel_structure_line`
- Количество raw/display: `12.92` / `12.92`
- Материалы raw/display: `0.0` / `0`
- Работы raw/display: `0.0` / `0`
- Итого raw/display: `0.0` / `0`
...
- Тип строки: `materials`
- Количество raw/display: `19.0` / `19.0`
- Материалы raw/display: `27550.0` / `27550`
- Работы raw/display: `0.0` / `0`
- Итого raw/display: `27550.0` / `27550`

### 9. Пиломатериал обрезной для устройства опалубки ГОСТ

- Тип строки: `materials`
- Количество raw/display: `0.646` / `0.65`
- Материалы raw/display: `13889.0` / `13889`
- Работы raw/display: `0.0` / `0`
- Итого raw/display: `13889.0` / `13889`
...
- Количество raw/display: `1.0` / `1.0`
- Материалы raw/display: `6861.65502` / `6862`
- Работы raw/display: `0.0` / `0`
- Итого raw/display: `6861.65502` / `6862`

### 24. Расходные материалы, амортизация инструмента

- Тип строки: `materials_overhead_percent`
- Количество raw/display: `1.0` / `1.0`
- Материалы raw/display: `20584.96506` / `20585`
- Работы raw/display: `0.0` / `0`
- Итого raw/display: `20584.96506` / `20585`
...
- internal_materials_total_raw: `484802.12208`
- internal_materials_total: `484802`
- internal_works_total_raw: `228810.0`
- internal_works_total: `228810`
- internal_section_total_raw: `713612.12208`
- internal_section_total: `713612`
- sum_of_displayed_line_material_totals: `484803`
- sum_of_displayed_line_work_totals: `228810`
- sum_of_displayed_line_totals: `713613`
...
| calculation_blocks | `formwork.beams_bottom_formwork_area_m2` | `formwork.beams_bottom_formwork_area_m2` | 0.0 | 0.0 | ok |
| calculation_blocks | `formwork.edge_beam_formwork_area_for_materials_m2` | `formwork.edge_beam_formwork_area_for_materials_m2` | 12.92 | 12.92 | ok |
...
| calculation_blocks | `plywood_and_timber.beams_bottom_formwork_area_m2` | `plywood_and_timber.beams_bottom_formwork_area_m2` | 0.0 | 0.0 | ok |
| calculation_blocks | `plywood_and_timber.edge_beam_formwork_area_for_materials_m2` | `plywood_and_timber.edge_beam_formwork_area_for_materials_m2` | 12.92 | 12.92 | ok |
| calculation_blocks | `plywood_and_timber.edge_plywood_sheets_raw` | `plywood_and_timber.edge_plywood_sheets_raw` | 5.617391 | 5.617391 | ok |
| calculation_blocks | `plywood_and_timber.base_plywood_sheets_raw` | `plywood_and_timber.base_plywood_sheets_raw` | 13.791304 | 13.791304 | ok |
| calculation_blocks | `plywood_and_timber.order_plywood_sheets_raw` | `plywood_and_timber.order_plywood_sheets_raw` | 18.791304 | 18.791304 | ok |
| calculation_blocks | `plywood_and_timber.plywood_sheets` | `plywood_and_timber.plywood_sheets` | 19 | 19 | ok |
| calculation_blocks | `plywood_and_timber.timber_volume_m3_raw` | `plywood_and_timber.timber_volume_m3_raw` | 0.646 | 0.646 | ok |
| calculation_blocks | `plywood_and_timber.timber_volume_m3_display` | `plywood_and_timber.timber_volume_m3_display` | 0.65 | 0.65 | ok |
| estimate_lines | `edge_formwork_installation_control` | `unit` | м2 | м2 | ok |
| estimate_lines | `edge_formwork_installation_control` | `quantity_raw` | 12.92 | 12.92 | ok |
| estimate_lines | `edge_formwork_installation_control` | `quantity_display` | 12.92 | 12.92 | ok |
