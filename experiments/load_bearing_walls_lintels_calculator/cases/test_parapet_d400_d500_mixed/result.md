# Расчёт несущих стен и перемычек: test_parapet_d400_d500_mixed

Проект: `test_parapet_d400_d500_mixed`

## Входные параметры
- `project_name`: `test_parapet_d400_d500_mixed`
...
- `parapet_masonry_volume_m3`: `15.0`
- `parapet_gas_block_d500_250_spec_volume_m3`: `6.74`
...
| `floor_2_load_bearing_walls.enabled` | `False` |
...
| `deliveries_and_cranes.gas_block_delivery_total_volume_m3` | `144.25` |
| `deliveries_and_cranes.gas_block_delivery_raw_trucks` | `4.5078` |
...
| Показатель | Значение |
| --- | ---: |
| `internal_materials_total_raw` | `1381413.826` |
| `internal_materials_total` | `1381414` |
| `internal_works_total_raw` | `999596.43` |
| `internal_works_total` | `999596` |
| `internal_section_total_raw` | `2381010.256` |
| `internal_section_total` | `2381010` |
| `sum_of_displayed_line_material_totals` | `1381414` |
| `sum_of_displayed_line_work_totals` | `999597` |
| `sum_of_displayed_line_totals` | `2381011` |
