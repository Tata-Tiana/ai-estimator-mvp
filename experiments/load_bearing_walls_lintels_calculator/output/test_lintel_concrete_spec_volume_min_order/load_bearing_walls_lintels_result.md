# Расчёт несущих стен и перемычек: test_lintel_concrete_spec_volume_min_order

Проект: `test_lintel_concrete_spec_volume_min_order`

## Входные параметры
- `project_name`: `test_lintel_concrete_spec_volume_min_order`
...
- `lintel_concrete_spec_volume_m3`: `0.38`
...
| `lintel_concrete_spec_volume_m3` | `0.38` |
| `lintel_required_concrete_volume_m3` | `0.38` |
| `lintel_concrete_min_order_volume_m3` | `1.0` |
...
| `lintels.lintel_concrete_spec_volume_m3` | `0.38` |
| `lintels.lintel_section_width_m` | `0.125` |
| `lintels.lintel_section_height_m` | `0.125` |
| `lintels.lintel_raw_concrete_volume_m3` | `0.38` |
| `lintels.lintel_required_concrete_volume_m3` | `0.38` |
...
| `calculation_blocks.lintels.lintel_concrete_spec_volume_m3` | `0.38` | `0.38` | `0.0` | `ok` |
| `calculation_blocks.lintels.lintel_raw_concrete_volume_m3` | `0.38` | `0.38` | `0.0` | `ok` |
| `calculation_blocks.lintels.lintel_required_concrete_volume_m3` | `0.38` | `0.38` | `0.0` | `ok` |
| `calculation_blocks.lintels.lintel_concrete_min_order_volume_m3` | `1.0` | `1.0` | `0.0` | `ok` |
| `calculation_blocks.lintels.lintel_concrete_order_volume_m3` | `1.0` | `1.0` | `0.0` | `ok` |
| `estimate_lines.lintel_concrete_b22_5_m300_material.quantity` | `1.0` | `1.0` | `0.0` | `ok` |
| `estimate_lines.lintel_concrete_b22_5_m300_material.material_total` | `6400` | `6400` | `0` | `ok` |
| `estimate_lines.lintel_concrete_b22_5_m300_material.line_total` | `6400` | `6400` | `0` | `ok` |
| `estimate_lines.manual_concrete_lifting.quantity` | `1.0` | `1.0` | `0.0` | `ok` |
| `estimate_lines.manual_concrete_lifting.work_total` | `5000` | `5000` | `0` | `ok` |
| `estimate_lines.manual_concrete_lifting.line_total` | `5000` | `5000` | `0` | `ok` |
