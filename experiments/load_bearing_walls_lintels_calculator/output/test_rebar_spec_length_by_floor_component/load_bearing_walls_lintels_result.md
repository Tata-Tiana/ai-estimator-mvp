# Расчёт несущих стен и перемычек: test_rebar_spec_length_by_floor_component

Проект: `test_rebar_spec_length_by_floor_component`

## Входные параметры
- `project_name`: `test_rebar_spec_length_by_floor_component`
...
- `lintel_rebar_items`: `[{'floor': 1, 'component': 'lintels', 'steel_class': 'A500', 'diameter_mm': 12, 'spec_length_m': 115.991, 'kg_per_meter': 0.888, 'rod_length_m': 11.7, 'unit_price_per_m': 45.29, 'code': None, 'name': None}, {'floor': 1, 'component': 'lintels', 'steel_class': 'A240', 'diameter_mm': 6, 'spec_length_m': 91.8919, 'kg_per_meter': 0.222, 'rod_length_m': 6, 'unit_price_per_m': 13.32, 'code': None, 'name': None}]`
...
- `main_wall_rebar_items`: `[{'floor': 1, 'component': 'load_bearing_walls', 'steel_class': 'A500', 'diameter_mm': 10, 'spec_length_m': 1070, 'kg_per_meter': 0.617, 'rod_length_m': 11.7, 'unit_price_per_m': 32.72, 'code': None, 'name': None}]`
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `1` | `load_bearing_walls` | `A500` | `10` | `1070.0` | `1123.5` | `97` | `1134.9` | `0.617` | `700.2333` | `rebar_a500_d10_m` |
...
| floor | component | steel_class | diameter_mm | spec_length_m | length_with_waste_m | rods | order_length_m | kg_per_meter | delivery_weight_kg | price_code |
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| `1` | `lintels` | `A500` | `12` | `115.991` | `121.7906` | `11` | `128.7` | `0.888` | `114.2856` | `rebar_a500_d12_m` |
| `1` | `lintels` | `A240` | `6` | `91.8919` | `96.4865` | `17` | `102.0` | `0.222` | `22.644` | `rebar_a240_d6_m` |
...
| `lintels.lintel_rebar_calc_method` | `spec_length_items` |
| `lintels.lintel_rebar_source` | `spec_length_items` |
| `lintels.rebar.lintels_floor_1_rebar_a500_d12.floor` | `1` |
| `lintels.rebar.lintels_floor_1_rebar_a500_d12.component` | `lintels` |
| `lintels.rebar.lintels_floor_1_rebar_a500_d12.steel_class` | `A500` |
| `lintels.rebar.lintels_floor_1_rebar_a500_d12.diameter_mm` | `12` |
| `lintels.rebar.lintels_floor_1_rebar_a500_d12.spec_length_m` | `115.991` |
| `lintels.rebar.lintels_floor_1_rebar_a500_d12.length_with_waste_m` | `121.7906` |
| `lintels.rebar.lintels_floor_1_rebar_a500_d12.raw_rods` | `10.4094` |
| `lintels.rebar.lintels_floor_1_rebar_a500_d12.rods` | `11` |
| `lintels.rebar.lintels_floor_1_rebar_a500_d12.order_length_m` | `128.7` |
| `lintels.rebar.lintels_floor_1_rebar_a500_d12.kg_per_meter` | `0.888` |
| `lintels.rebar.lintels_floor_1_rebar_a500_d12.delivery_weight_kg` | `114.2856` |
| `lintels.rebar.lintels_floor_1_rebar_a500_d12.unit_price_per_m` | `45.29` |
| `lintels.rebar.lintels_floor_1_rebar_a500_d12.price_code` | `rebar_a500_d12_m` |
| `lintels.rebar.lintels_floor_1_rebar_a500_d12.line_code` | `lintels_floor_1_rebar_a500_d12` |
| `lintels.rebar.lintels_floor_1_rebar_a500_d12.line_name` | `Арматура A500 Ø12 для перемычек, этаж 1` |
| `lintels.rebar.lintels_floor_1_rebar_a240_d6.floor` | `1` |
| `lintels.rebar.lintels_floor_1_rebar_a240_d6.component` | `lintels` |
| `lintels.rebar.lintels_floor_1_rebar_a240_d6.steel_class` | `A240` |
| `lintels.rebar.lintels_floor_1_rebar_a240_d6.diameter_mm` | `6` |
| `lintels.rebar.lintels_floor_1_rebar_a240_d6.spec_length_m` | `91.8919` |
| `lintels.rebar.lintels_floor_1_rebar_a240_d6.length_with_waste_m` | `96.4865` |
| `lintels.rebar.lintels_floor_1_rebar_a240_d6.raw_rods` | `16.0811` |
| `lintels.rebar.lintels_floor_1_rebar_a240_d6.rods` | `17` |
| `lintels.rebar.lintels_floor_1_rebar_a240_d6.order_length_m` | `102.0` |
| `lintels.rebar.lintels_floor_1_rebar_a240_d6.kg_per_meter` | `0.222` |
| `lintels.rebar.lintels_floor_1_rebar_a240_d6.delivery_weight_kg` | `22.644` |
| `lintels.rebar.lintels_floor_1_rebar_a240_d6.unit_price_per_m` | `13.32` |
| `lintels.rebar.lintels_floor_1_rebar_a240_d6.price_code` | `rebar_a240_d6_m` |
| `lintels.rebar.lintels_floor_1_rebar_a240_d6.line_code` | `lintels_floor_1_rebar_a240_d6` |
| `lintels.rebar.lintels_floor_1_rebar_a240_d6.line_name` | `Арматура A240 Ø6 для перемычек, этаж 1` |
| `lintels.lintel_rebar_base_length_m` | `207.8829` |
...
| `main_wall_reinforcement.main_wall_rebar_calc_method` | `spec_length_items` |
| `main_wall_reinforcement.main_wall_rebar_source` | `spec_length_items` |
| `main_wall_reinforcement.items.load_bearing_walls_floor_1_rebar_a500_d10.floor` | `1` |
| `main_wall_reinforcement.items.load_bearing_walls_floor_1_rebar_a500_d10.component` | `load_bearing_walls` |
| `main_wall_reinforcement.items.load_bearing_walls_floor_1_rebar_a500_d10.steel_class` | `A500` |
| `main_wall_reinforcement.items.load_bearing_walls_floor_1_rebar_a500_d10.diameter_mm` | `10` |
| `main_wall_reinforcement.items.load_bearing_walls_floor_1_rebar_a500_d10.spec_length_m` | `1070.0` |
| `main_wall_reinforcement.items.load_bearing_walls_floor_1_rebar_a500_d10.length_with_waste_m` | `1123.5` |
| `main_wall_reinforcement.items.load_bearing_walls_floor_1_rebar_a500_d10.raw_rods` | `96.0256` |
| `main_wall_reinforcement.items.load_bearing_walls_floor_1_rebar_a500_d10.rods` | `97` |
| `main_wall_reinforcement.items.load_bearing_walls_floor_1_rebar_a500_d10.order_length_m` | `1134.9` |
| `main_wall_reinforcement.items.load_bearing_walls_floor_1_rebar_a500_d10.kg_per_meter` | `0.617` |
| `main_wall_reinforcement.items.load_bearing_walls_floor_1_rebar_a500_d10.delivery_weight_kg` | `700.2333` |
| `main_wall_reinforcement.items.load_bearing_walls_floor_1_rebar_a500_d10.unit_price_per_m` | `32.72` |
| `main_wall_reinforcement.items.load_bearing_walls_floor_1_rebar_a500_d10.price_code` | `rebar_a500_d10_m` |
| `main_wall_reinforcement.items.load_bearing_walls_floor_1_rebar_a500_d10.line_code` | `load_bearing_walls_floor_1_rebar_a500_d10` |
| `main_wall_reinforcement.items.load_bearing_walls_floor_1_rebar_a500_d10.line_name` | `Арматура A500 Ø10 для несущих стен, этаж 1` |
| `main_wall_reinforcement.main_wall_rebar_base_length_m` | `1070.0` |
| `main_wall_reinforcement.main_wall_rebar_order_length_m` | `1134.9` |
| `main_wall_reinforcement.main_wall_rebar_delivery_weight_kg` | `700.2333` |
| `main_wall_reinforcement.main_wall_chasing_quantity_m` | `1070.0` |
| `floor_2_load_bearing_walls.floors_count` | `1` |
| `floor_2_load_bearing_walls.upper_floor_calc_method` | `legacy_second_light_addon` |
| `floor_2_load_bearing_walls.enabled` | `True` |
| `floor_2_load_bearing_walls.floor_2_load_bearing_walls_enabled` | `False` |
...
| `load_bearing_walls_floor_1_rebar_a500_d10` | Арматура A500 Ø10 для несущих стен, этаж 1 | `1134.9` | `` | `мп` | `32.72` | `37133.928` | `37134` | `0.0` | `0.0` | `0` | `37133.928` | `37134` | `False` |
...
| `lintels_floor_1_rebar_a500_d12` | Арматура A500 Ø12 для перемычек, этаж 1 | `128.7` | `` | `мп` | `45.29` | `5828.823` | `5829` | `0.0` | `0.0` | `0` | `5828.823` | `5829` | `False` |
| `lintels_floor_1_rebar_a240_d6` | Арматура A240 Ø6 для перемычек, этаж 1 | `102.0` | `` | `мп` | `13.32` | `1358.64` | `1359` | `0.0` | `0.0` | `0` | `1358.64` | `1359` | `False` |
...
| --- | ---: | ---: | ---: | --- |
| `calculation_blocks.main_wall_reinforcement.main_wall_rebar_calc_method` | `spec_length_items` | `spec_length_items` | `` | `ok` |
| `calculation_blocks.main_wall_reinforcement.main_wall_rebar_source` | `spec_length_items` | `spec_length_items` | `` | `ok` |
| `calculation_blocks.main_wall_reinforcement.main_wall_rebar_base_length_m` | `1070` | `1070.0` | `0.0` | `ok` |
| `calculation_blocks.main_wall_reinforcement.main_wall_rebar_order_length_m` | `1134.9` | `1134.9` | `0.0` | `ok` |
| `calculation_blocks.main_wall_reinforcement.main_wall_rebar_delivery_weight_kg` | `700.2333` | `700.2333` | `0.0` | `ok` |
| `calculation_blocks.lintels.lintel_rebar_calc_method` | `spec_length_items` | `spec_length_items` | `` | `ok` |
| `calculation_blocks.lintels.lintel_rebar_source` | `spec_length_items` | `spec_length_items` | `` | `ok` |
| `calculation_blocks.lintels.lintel_rebar_base_length_m` | `207.8829` | `207.8829` | `0.0` | `ok` |
| `calculation_blocks.lintels.lintel_rebar_order_length_m` | `230.7` | `230.7` | `0.0` | `ok` |
| `calculation_blocks.lintels.lintel_rebar_delivery_weight_kg` | `136.9296` | `136.9296` | `0.0` | `ok` |
| `calculation_blocks.lintels.lintel_rebar_frame_assembly_quantity_m` | `230.7` | `230.7` | `0.0` | `ok` |
| `estimate_lines.load_bearing_walls_floor_1_rebar_a500_d10.quantity` | `1134.9` | `1134.9` | `0.0` | `ok` |
| `estimate_lines.load_bearing_walls_floor_1_rebar_a500_d10.price_code` | `rebar_a500_d10_m` | `rebar_a500_d10_m` | `` | `ok` |
| `estimate_lines.lintels_floor_1_rebar_a500_d12.quantity` | `128.7` | `128.7` | `0.0` | `ok` |
| `estimate_lines.lintels_floor_1_rebar_a500_d12.price_code` | `rebar_a500_d12_m` | `rebar_a500_d12_m` | `` | `ok` |
| `estimate_lines.lintels_floor_1_rebar_a240_d6.quantity` | `102` | `102.0` | `0.0` | `ok` |
| `estimate_lines.lintels_floor_1_rebar_a240_d6.price_code` | `rebar_a240_d6_m` | `rebar_a240_d6_m` | `` | `ok` |
