# Расчёт несущих стен и перемычек: test_load_bearing_walls_lintels

Проект: `test_load_bearing_walls_lintels`

## Входные параметры
- `project_name`: `test_load_bearing_walls_lintels`
...
| `scaffolding.setup_quantity` | `1.0` |
| `scaffolding.timber_quantity_m3` | `1.0` |
...
| `sum_of_displayed_line_material_totals` | `1550656` |
| `sum_of_displayed_line_work_totals` | `1121449` |
| `sum_of_displayed_line_totals` | `2672105` |
...
| --- | ---: | ---: | ---: | --- |
| `calculation_blocks.cutoff_waterproofing.cutoff_waterproofing_area_m2` | `40.59` | `40.59` | `0.0` | `ok` |
| `calculation_blocks.main_walls.main_masonry_volume_m3` | `109.35` | `109.35` | `0.0` | `ok` |
| `calculation_blocks.main_gas_blocks.d400.pallets` | `39` | `39` | `0` | `ok` |
| `calculation_blocks.main_gas_blocks.d400.order_volume_m3` | `83.85` | `83.85` | `0.0` | `ok` |
| `calculation_blocks.main_gas_blocks.d500_250.pallets` | `18` | `18` | `0` | `ok` |
| `calculation_blocks.main_gas_blocks.d500_250.order_volume_m3` | `32.4` | `32.4` | `0.0` | `ok` |
| `calculation_blocks.adhesive_and_sand_concrete.main_adhesive_bags` | `138` | `138` | `0` | `ok` |
| `calculation_blocks.adhesive_and_sand_concrete.sand_concrete_bags` | `39` | `39` | `0` | `ok` |
| `calculation_blocks.lintels.lintel_total_length_m` | `23.4` | `23.4` | `0.0` | `ok` |
| `calculation_blocks.lintels.u_block_quantity` | `39` | `39.0` | `0.0` | `ok` |
| `calculation_blocks.lintels.lintel_rebar_frame_assembly_quantity_m` | `230.7` | `230.7` | `0.0` | `ok` |
| `calculation_blocks.lintels.rebar.lintel_rebar_a500_d12.order_length_m` | `128.7` | `128.7` | `0.0` | `ok` |
| `calculation_blocks.lintels.rebar.lintel_rebar_a240_d6.order_length_m` | `102` | `102.0` | `0.0` | `ok` |
| `calculation_blocks.lintels.lintel_concrete_order_volume_m3` | `1` | `1.0` | `0.0` | `ok` |
| `calculation_blocks.main_wall_reinforcement.main_wall_chasing_quantity_m` | `1070` | `1070.0` | `0.0` | `ok` |
| `calculation_blocks.main_wall_reinforcement.main_wall_rebar_a500_d10.order_length_m` | `1134.9` | `1134.9` | `0.0` | `ok` |
| `calculation_blocks.deliveries_and_cranes.gas_block_delivery_total_volume_m3` | `158.55` | `158.55` | `0.0` | `ok` |
| `calculation_blocks.deliveries_and_cranes.gas_block_delivery_trucks` | `5` | `5` | `0` | `ok` |
| `calculation_blocks.parapet.parapet_upper_level_total_volume_m3` | `36.24` | `36.24` | `0.0` | `ok` |
| `calculation_blocks.parapet.parapet_and_upper_level_d400.order_volume_m3` | `38.7` | `38.7` | `0.0` | `ok` |
| `calculation_blocks.parapet.parapet_rebar_order_length_m` | `245.7` | `245.7` | `0.0` | `ok` |
| `calculation_blocks.second_light_addon.second_light_masonry_case_specific` | `True` | `True` | `0` | `ok` |
| `calculation_blocks.second_light_addon.second_light_masonry_volume_m3` | `13.5` | `13.5` | `0.0` | `ok` |
| `calculation_blocks.second_light_addon.second_light_rebar_order_length_m` | `163.8` | `163.8` | `0.0` | `ok` |
| `calculation_blocks.vent_chimney_cladding.vent_chimney_cladding_area_m2` | `11.4666666667` | `11.4666666667` | `0.0` | `ok` |
| `calculation_blocks.vent_chimney_cladding.vent_chimney_d500_150.order_volume_m3` | `3.6` | `3.6` | `0.0` | `ok` |
| `calculation_blocks.overheads.parapet_upper_level_adhesive_bags` | `49` | `49` | `0` | `ok` |
| `calculation_blocks.overheads.parapet_and_second_light_rebar_order_length_m` | `409.5` | `409.5` | `0.0` | `ok` |
| `calculation_blocks.overheads.walls_consumables_tool_amortization_amount_raw` | `100521.7` | `100521.7` | `0.0` | `ok` |
| `estimate_lines.cutoff_waterproofing_under_first_row_blocks.quantity` | `40.59` | `40.59` | `0.0` | `ok` |
| `estimate_lines.cutoff_waterproofing_under_first_row_blocks.material_total_raw` | `10147.5` | `10147.5` | `0.0` | `ok` |
| `estimate_lines.cutoff_waterproofing_under_first_row_blocks.material_total` | `10148` | `10148` | `0` | `ok` |
| `estimate_lines.cutoff_waterproofing_under_first_row_blocks.work_total_raw` | `4059` | `4059.0` | `0.0` | `ok` |
| `estimate_lines.cutoff_waterproofing_under_first_row_blocks.work_total` | `4059` | `4059` | `0` | `ok` |
| `estimate_lines.cutoff_waterproofing_under_first_row_blocks.line_total_raw` | `14206.5` | `14206.5` | `0.0` | `ok` |
| `estimate_lines.cutoff_waterproofing_under_first_row_blocks.line_total` | `14207` | `14207` | `0` | `ok` |
| `estimate_lines.main_load_bearing_wall_masonry_work.quantity` | `109.35` | `109.35` | `0.0` | `ok` |
| `estimate_lines.main_load_bearing_wall_masonry_work.work_total` | `765450` | `765450` | `0` | `ok` |
| `estimate_lines.main_load_bearing_wall_masonry_work.line_total` | `765450` | `765450` | `0` | `ok` |
| `estimate_lines.main_gas_block_d400_600x400x250_material.quantity` | `83.85` | `83.85` | `0.0` | `ok` |
| `estimate_lines.main_gas_block_d400_600x400x250_material.material_total` | `503100` | `503100` | `0` | `ok` |
| `estimate_lines.main_gas_block_d400_600x400x250_material.line_total` | `503100` | `503100` | `0` | `ok` |
| `estimate_lines.main_gas_block_d500_600x250x250_material.quantity` | `32.4` | `32.4` | `0.0` | `ok` |
| `estimate_lines.main_gas_block_d500_600x250x250_material.material_total` | `178200` | `178200` | `0` | `ok` |
| `estimate_lines.main_gas_block_d500_600x250x250_material.line_total` | `178200` | `178200` | `0` | `ok` |
| `estimate_lines.main_gas_block_adhesive.quantity` | `138` | `138.0` | `0.0` | `ok` |
| `estimate_lines.main_gas_block_adhesive.material_total` | `46920` | `46920` | `0` | `ok` |
| `estimate_lines.main_gas_block_adhesive.line_total` | `46920` | `46920` | `0` | `ok` |
| `estimate_lines.sand_concrete_m300_first_row.quantity` | `39` | `39.0` | `0.0` | `ok` |
| `estimate_lines.sand_concrete_m300_first_row.material_total` | `14625` | `14625` | `0` | `ok` |
| `estimate_lines.sand_concrete_m300_first_row.line_total` | `14625` | `14625` | `0` | `ok` |
| `estimate_lines.u_block_lintel_cutting.quantity` | `39` | `39.0` | `0.0` | `ok` |
| `estimate_lines.u_block_lintel_cutting.work_total` | `15600` | `15600` | `0` | `ok` |
| `estimate_lines.u_block_lintel_cutting.line_total` | `15600` | `15600` | `0` | `ok` |
| `estimate_lines.main_wall_chasing_for_d10_reinforcement.quantity` | `1070` | `1070.0` | `0.0` | `ok` |
| `estimate_lines.main_wall_chasing_for_d10_reinforcement.line_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.main_wall_rebar_a500_d10.quantity` | `1134.9` | `1134.9` | `0.0` | `ok` |
| `estimate_lines.main_wall_rebar_a500_d10.material_total_raw` | `37133.928` | `37133.928` | `0.0` | `ok` |
| `estimate_lines.main_wall_rebar_a500_d10.material_total` | `37134` | `37134` | `0` | `ok` |
| `estimate_lines.main_wall_rebar_a500_d10.line_total` | `37134` | `37134` | `0` | `ok` |
| `estimate_lines.gas_blocks_and_mix_delivery.quantity` | `5` | `5.0` | `0.0` | `ok` |
| `estimate_lines.gas_blocks_and_mix_delivery.material_total` | `140000` | `140000` | `0` | `ok` |
| `estimate_lines.gas_blocks_and_mix_delivery.line_total` | `140000` | `140000` | `0` | `ok` |
| `estimate_lines.gas_blocks_unloading_manipulator.quantity` | `5` | `5.0` | `0.0` | `ok` |
| `estimate_lines.gas_blocks_unloading_manipulator.material_total` | `75000` | `75000` | `0` | `ok` |
| `estimate_lines.gas_blocks_unloading_manipulator.line_total` | `75000` | `75000` | `0` | `ok` |
| `estimate_lines.lintel_rebar_frame_assembly.quantity` | `230.7` | `230.7` | `0.0` | `ok` |
| `estimate_lines.lintel_rebar_frame_assembly.line_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.lintel_rebar_a500_d12.quantity` | `128.7` | `128.7` | `0.0` | `ok` |
| `estimate_lines.lintel_rebar_a500_d12.material_total_raw` | `5828.823` | `5828.823` | `0.0` | `ok` |
| `estimate_lines.lintel_rebar_a500_d12.material_total` | `5829` | `5829` | `0` | `ok` |
| `estimate_lines.lintel_rebar_a240_d6.quantity` | `102` | `102.0` | `0.0` | `ok` |
| `estimate_lines.lintel_rebar_a240_d6.material_total_raw` | `1358.64` | `1358.64` | `0.0` | `ok` |
| `estimate_lines.lintel_rebar_a240_d6.material_total` | `1359` | `1359` | `0` | `ok` |
| `estimate_lines.lintel_concrete_b22_5_m300_material.quantity` | `1` | `1.0` | `0.0` | `ok` |
| `estimate_lines.lintel_concrete_b22_5_m300_material.material_total` | `6400` | `6400` | `0` | `ok` |
| `estimate_lines.parapet_and_upper_level_masonry_work.quantity` | `36.24` | `36.24` | `0.0` | `ok` |
| `estimate_lines.parapet_and_upper_level_masonry_work.work_total` | `253680` | `253680` | `0` | `ok` |
| `estimate_lines.parapet_and_upper_level_masonry_work.is_case_specific` | `True` | `True` | `0` | `ok` |
| `estimate_lines.parapet_and_upper_level_gas_block_d400_material.quantity` | `38.7` | `38.7` | `0.0` | `ok` |
| `estimate_lines.parapet_and_upper_level_gas_block_d400_material.material_total` | `232200` | `232200` | `0` | `ok` |
| `estimate_lines.parapet_and_upper_level_gas_block_d400_material.is_case_specific` | `True` | `True` | `0` | `ok` |
...
| `estimate_lines.vent_chimney_gas_block_cladding_work.work_total_raw` | `13760` | `13760.0` | `0.0` | `ok` |
| `estimate_lines.vent_chimney_gas_block_cladding_work.work_total` | `13760` | `13760` | `0` | `ok` |
| `estimate_lines.vent_chimney_gas_block_d500_600x150x250_material.quantity` | `3.6` | `3.6` | `0.0` | `ok` |
| `estimate_lines.vent_chimney_gas_block_d500_600x150x250_material.material_total` | `20160` | `20160` | `0` | `ok` |
| `estimate_lines.parapet_upper_level_adhesive.quantity` | `49` | `49.0` | `0.0` | `ok` |
| `estimate_lines.parapet_upper_level_adhesive.material_total` | `16660` | `16660` | `0` | `ok` |
| `estimate_lines.parapet_upper_level_adhesive.is_case_specific` | `True` | `True` | `0` | `ok` |
| `estimate_lines.parapet_and_second_light_chasing_for_d10_reinforcement.quantity` | `384.76` | `384.76` | `0.0` | `ok` |
| `estimate_lines.parapet_and_second_light_chasing_for_d10_reinforcement.line_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.parapet_and_second_light_chasing_for_d10_reinforcement.is_case_specific` | `True` | `True` | `0` | `ok` |
| `estimate_lines.parapet_and_second_light_rebar_a500_d10.quantity` | `409.5` | `409.5` | `0.0` | `ok` |
| `estimate_lines.parapet_and_second_light_rebar_a500_d10.material_total_raw` | `13398.84` | `13398.84` | `0.0` | `ok` |
| `estimate_lines.parapet_and_second_light_rebar_a500_d10.material_total` | `13399` | `13399` | `0` | `ok` |
| `estimate_lines.parapet_and_second_light_rebar_a500_d10.is_case_specific` | `True` | `True` | `0` | `ok` |
| `estimate_lines.walls_consumables_tool_amortization.quantity` | `1` | `1.0` | `0.0` | `ok` |
| `estimate_lines.walls_consumables_tool_amortization.material_unit_price` | `100522` | `100522` | `0` | `ok` |
| `estimate_lines.walls_consumables_tool_amortization.material_total_raw` | `100521.7` | `100521.7` | `0.0` | `ok` |
| `estimate_lines.walls_consumables_tool_amortization.material_total` | `100522` | `100522` | `0` | `ok` |
| `estimate_lines.walls_consumables_tool_amortization.line_total` | `100522` | `100522` | `0` | `ok` |
| `estimate_lines.construction_waste_removal.quantity` | `3` | `3.0` | `0.0` | `ok` |
| `estimate_lines.construction_waste_removal.material_total` | `30000` | `30000` | `0` | `ok` |
| `estimate_lines.construction_waste_removal.work_total` | `10500` | `10500` | `0` | `ok` |
| `estimate_lines.construction_waste_removal.line_total` | `40500` | `40500` | `0` | `ok` |
| `estimate_lines.walls_technical_supervision.quantity` | `1` | `1.0` | `0.0` | `ok` |
| `estimate_lines.walls_technical_supervision.work_total` | `10000` | `10000` | `0` | `ok` |
| `estimate_lines.walls_technical_supervision.line_total` | `10000` | `10000` | `0` | `ok` |
| `internal_totals.internal_materials_total_raw` | `1550654.431` | `1550654.431` | `0.0` | `ok` |
| `internal_totals.internal_materials_total` | `1550654` | `1550654` | `0` | `ok` |
| `internal_totals.internal_works_total_raw` | `1121449` | `1121449.0` | `0.0` | `ok` |
| `internal_totals.internal_works_total` | `1121449` | `1121449` | `0` | `ok` |
| `internal_totals.internal_section_total_raw` | `2672103.431` | `2672103.431` | `0.0` | `ok` |
| `internal_totals.internal_section_total` | `2672103` | `2672103` | `0` | `ok` |
| `internal_totals.sum_of_displayed_line_material_totals` | `1550656` | `1550656` | `0` | `ok` |
| `internal_totals.sum_of_displayed_line_work_totals` | `1121449` | `1121449` | `0` | `ok` |
| `internal_totals.sum_of_displayed_line_totals` | `2672105` | `2672105` | `0` | `ok` |
