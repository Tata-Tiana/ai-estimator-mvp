# Расчёт несущих стен и перемычек: test_cutoff_waterproofing_spec_area

Проект: `test_cutoff_waterproofing_spec_area`

## Входные параметры
- `project_name`: `test_cutoff_waterproofing_spec_area`
...
| `cutoff_waterproofing.cutoff_waterproofing_load_bearing_walls_area_m2` | `40.59` |
...
| --- | ---: | ---: | ---: | --- |
| `calculation_blocks.cutoff_waterproofing.cutoff_waterproofing_calc_method` | `spec_area` | `spec_area` | `` | `ok` |
| `calculation_blocks.cutoff_waterproofing.cutoff_waterproofing_source` | `spec_area` | `spec_area` | `` | `ok` |
| `calculation_blocks.cutoff_waterproofing.cutoff_waterproofing_load_bearing_walls_area_m2` | `40.59` | `40.59` | `0.0` | `ok` |
