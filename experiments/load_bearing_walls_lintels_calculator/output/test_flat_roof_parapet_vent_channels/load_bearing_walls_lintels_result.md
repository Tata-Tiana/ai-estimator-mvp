# Расчёт несущих стен и перемычек: test_flat_roof_parapet_vent_channels

Проект: `test_flat_roof_parapet_vent_channels`

## Входные параметры
- `project_name`: `test_flat_roof_parapet_vent_channels`
