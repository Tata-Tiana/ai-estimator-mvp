# Расчёт несущих стен и перемычек: test_main_walls_crane_from_delivery_trucks_four

Проект: `test_main_walls_crane_from_delivery_trucks_four`

## Входные параметры
- `project_name`: `test_main_walls_crane_from_delivery_trucks_four`
...
- `gas_block_delivery_truck_capacity_m3`: `40`
...
| `deliveries_and_cranes.gas_block_delivery_raw_trucks` | `3.9638` |
...
| Показатель | Значение |
| --- | ---: |
| `internal_materials_total_raw` | `1507654.431` |
| `internal_materials_total` | `1507654` |
| `internal_works_total_raw` | `1121449.0` |
| `internal_works_total` | `1121449` |
| `internal_section_total_raw` | `2629103.431` |
| `internal_section_total` | `2629103` |
| `sum_of_displayed_line_material_totals` | `1507656` |
| `sum_of_displayed_line_work_totals` | `1121449` |
| `sum_of_displayed_line_totals` | `2629105` |
...
| --- | ---: | ---: | ---: | --- |
| `calculation_blocks.deliveries_and_cranes.gas_block_delivery_trucks` | `4` | `4` | `0` | `ok` |
...
| `calculation_blocks.deliveries_and_cranes.main_walls_crane_shifts` | `2` | `2` | `0` | `ok` |
| `estimate_lines.main_walls_blocks_crane_moving_25t.quantity` | `2` | `2.0` | `0.0` | `ok` |
| `estimate_lines.main_walls_blocks_crane_moving_25t.material_total` | `60000` | `60000` | `0` | `ok` |
| `estimate_lines.main_walls_blocks_crane_moving_25t.line_total` | `60000` | `60000` | `0` | `ok` |
