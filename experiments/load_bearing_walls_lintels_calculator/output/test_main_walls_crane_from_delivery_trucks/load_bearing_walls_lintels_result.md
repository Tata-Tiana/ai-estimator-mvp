# Расчёт несущих стен и перемычек: test_main_walls_crane_from_delivery_trucks

Проект: `test_main_walls_crane_from_delivery_trucks`

## Входные параметры
- `project_name`: `test_main_walls_crane_from_delivery_trucks`
...
- `gas_block_delivery_truck_capacity_m3`: `60`
...
| `deliveries_and_cranes.gas_block_delivery_raw_trucks` | `2.6425` |
| `deliveries_and_cranes.main_walls_crane_calc_method` | `delivery_trucks_threshold` |
| `deliveries_and_cranes.main_walls_crane_source` | `delivery_trucks_threshold` |
| `deliveries_and_cranes.gas_block_delivery_trucks` | `3` |
| `deliveries_and_cranes.main_walls_crane_threshold_trucks` | `3` |
| `deliveries_and_cranes.main_walls_crane_shifts` | `1` |
...
| `gas_blocks_and_mix_delivery` | Доставка блоков, смеси | `3.0` | `` | `маш` | `28000` | `84000.0` | `84000` | `0.0` | `0.0` | `0` | `84000.0` | `84000` | `False` |
| `gas_blocks_unloading_manipulator` | Разгрузка блоков, смеси манипулятором | `3.0` | `` | `маш` | `15000` | `45000.0` | `45000` | `0.0` | `0.0` | `0` | `45000.0` | `45000` | `False` |
| `main_walls_blocks_crane_moving_25t` | Перемещение блоков, смеси автокраном 25 т | `1.0` | `` | `смена` | `30000` | `30000.0` | `30000` | `0.0` | `0.0` | `0` | `30000.0` | `30000` | `False` |
...
| Показатель | Значение |
| --- | ---: |
| `internal_materials_total_raw` | `1434654.431` |
| `internal_materials_total` | `1434654` |
| `internal_works_total_raw` | `1121449.0` |
| `internal_works_total` | `1121449` |
| `internal_section_total_raw` | `2556103.431` |
| `internal_section_total` | `2556103` |
| `sum_of_displayed_line_material_totals` | `1434656` |
| `sum_of_displayed_line_work_totals` | `1121449` |
| `sum_of_displayed_line_totals` | `2556105` |
...
| --- | ---: | ---: | ---: | --- |
| `calculation_blocks.deliveries_and_cranes.gas_block_delivery_trucks` | `3` | `3` | `0` | `ok` |
| `calculation_blocks.deliveries_and_cranes.main_walls_crane_calc_method` | `delivery_trucks_threshold` | `delivery_trucks_threshold` | `` | `ok` |
| `calculation_blocks.deliveries_and_cranes.main_walls_crane_source` | `delivery_trucks_threshold` | `delivery_trucks_threshold` | `` | `ok` |
| `calculation_blocks.deliveries_and_cranes.main_walls_crane_shifts` | `1` | `1` | `0` | `ok` |
| `estimate_lines.main_walls_blocks_crane_moving_25t.quantity` | `1` | `1.0` | `0.0` | `ok` |
| `estimate_lines.main_walls_blocks_crane_moving_25t.material_total` | `30000` | `30000` | `0` | `ok` |
| `estimate_lines.main_walls_blocks_crane_moving_25t.line_total` | `30000` | `30000` | `0` | `ok` |
