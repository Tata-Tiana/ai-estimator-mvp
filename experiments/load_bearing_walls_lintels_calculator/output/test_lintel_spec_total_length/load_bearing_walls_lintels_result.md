# Расчёт несущих стен и перемычек: test_lintel_spec_total_length

Проект: `test_lintel_spec_total_length`

## Входные параметры
- `project_name`: `test_lintel_spec_total_length`
...
| --- | ---: | ---: | ---: | --- |
| `calculation_blocks.lintels.lintel_length_calc_method` | `spec_total_length` | `spec_total_length` | `` | `ok` |
| `calculation_blocks.lintels.lintel_length_source` | `spec_total_length` | `spec_total_length` | `` | `ok` |
| `calculation_blocks.lintels.lintel_total_length_m` | `23.4` | `23.4` | `0.0` | `ok` |
| `calculation_blocks.lintels.gas_block_length_m` | `0.6` | `0.6` | `0.0` | `ok` |
| `calculation_blocks.lintels.u_block_quantity` | `39` | `39.0` | `0.0` | `ok` |
| `calculation_blocks.lintels.lintel_raw_concrete_volume_m3` | `0.3656` | `0.3656` | `0.0` | `ok` |
| `calculation_blocks.lintels.lintel_required_concrete_volume_m3` | `0.3839` | `0.3839` | `0.0` | `ok` |
...
| `estimate_lines.u_block_lintel_cutting.unit` | `шт` | `шт` | `` | `ok` |
| `estimate_lines.u_block_lintel_cutting.work_total` | `15600` | `15600` | `0` | `ok` |
| `estimate_lines.lintel_concreting_work.quantity` | `23.4` | `23.4` | `0.0` | `ok` |
| `estimate_lines.lintel_concreting_work.work_total` | `23400` | `23400` | `0` | `ok` |
