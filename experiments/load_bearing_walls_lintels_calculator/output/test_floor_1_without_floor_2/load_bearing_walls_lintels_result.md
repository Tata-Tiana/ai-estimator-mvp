# Расчёт несущих стен и перемычек: test_floor_1_without_floor_2

Проект: `test_floor_1_without_floor_2`

## Входные параметры
- `project_name`: `test_floor_1_without_floor_2`
...
| Показатель | Значение |
| --- | ---: |
| `internal_materials_total_raw` | `1195235.591` |
| `internal_materials_total` | `1195236` |
| `internal_works_total_raw` | `854009.0` |
| `internal_works_total` | `854009` |
| `internal_section_total_raw` | `2049244.591` |
| `internal_section_total` | `2049245` |
| `sum_of_displayed_line_material_totals` | `1195237` |
| `sum_of_displayed_line_work_totals` | `854009` |
| `sum_of_displayed_line_totals` | `2049246` |
...
| `calculation_blocks.floor_2_load_bearing_walls.floor_2_load_bearing_walls_enabled` | `False` | `False` | `0` | `ok` |
| `calculation_blocks.floor_2_load_bearing_walls.floor_2_masonry_volume_m3` | `0.0` | `0.0` | `0.0` | `ok` |
| `calculation_blocks.parapet.parapet_calc_method` | `flat_roof_spec_volume` | `flat_roof_spec_volume` | `` | `ok` |
| `calculation_blocks.parapet.flat_roof_enabled` | `False` | `False` | `0` | `ok` |
| `calculation_blocks.parapet.parapet_enabled_calculated` | `False` | `False` | `0` | `ok` |
...
| `calculation_blocks.vent_chimney_cladding.flat_roof_enabled` | `False` | `False` | `0` | `ok` |
| `calculation_blocks.vent_chimney_cladding.vent_chimney_cladding_enabled_calculated` | `False` | `False` | `0` | `ok` |
