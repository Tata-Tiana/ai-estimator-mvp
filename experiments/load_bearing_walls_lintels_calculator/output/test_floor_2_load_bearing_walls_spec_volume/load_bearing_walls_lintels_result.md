# Расчёт несущих стен и перемычек: test_floor_2_load_bearing_walls_spec_volume

Проект: `test_floor_2_load_bearing_walls_spec_volume`

## Входные параметры
- `project_name`: `test_floor_2_load_bearing_walls_spec_volume`
...
- `floor_2_masonry_volume_m3`: `13.5`
...
| `floor_2_load_bearing_walls.floor_2_masonry_volume_m3` | `13.5` |
| `floor_2_load_bearing_walls.floor_2_d400.spec_volume_m3` | `13.5` |
| `floor_2_load_bearing_walls.floor_2_d400.required_volume_m3` | `14.175` |
| `floor_2_load_bearing_walls.floor_2_d400.raw_pallets` | `6.593` |
| `floor_2_load_bearing_walls.floor_2_d400.pallets` | `7` |
| `floor_2_load_bearing_walls.floor_2_d400.order_volume_m3` | `15.05` |
| `floor_2_load_bearing_walls.floor_2_adhesive_raw_bags` | `17.01` |
| `floor_2_load_bearing_walls.floor_2_adhesive_bags` | `18` |
| `deliveries_and_cranes.gas_block_delivery_total_volume_m3` | `131.3` |
| `deliveries_and_cranes.gas_block_delivery_raw_trucks` | `4.1031` |
...
| `parapet.parapet_total_masonry_volume_m3` | `0.0` |
...
| `overheads.floor_2_adhesive_raw_bags` | `17.01` |
| `overheads.floor_2_adhesive_bags` | `18` |
...
| `floor_2_masonry_work` | Кладка несущих стен 2-го этажа из газобетонных блоков | `13.5` | `` | `м3` | `0.0` | `0.0` | `0` | `7000` | `94500.0` | `94500` | `94500.0` | `94500` | `False` |
...
| `floor_2_masonry_glue` | Монтажный клей для блоков 2-го этажа | `18.0` | `` | `мешок` | `340` | `6120.0` | `6120` | `0.0` | `0.0` | `0` | `6120.0` | `6120` | `False` |
...
| Показатель | Значение |
| --- | ---: |
| `internal_materials_total_raw` | `1334655.591` |
| `internal_materials_total` | `1334656` |
| `internal_works_total_raw` | `948509.0` |
| `internal_works_total` | `948509` |
| `internal_section_total_raw` | `2283164.591` |
| `internal_section_total` | `2283165` |
| `sum_of_displayed_line_material_totals` | `1334657` |
| `sum_of_displayed_line_work_totals` | `948509` |
| `sum_of_displayed_line_totals` | `2283166` |
...
| --- | ---: | ---: | ---: | --- |
| `calculation_blocks.floor_2_load_bearing_walls.floors_count` | `2` | `2` | `0` | `ok` |
| `calculation_blocks.floor_2_load_bearing_walls.upper_floor_calc_method` | `floor_2_spec_volume` | `floor_2_spec_volume` | `` | `ok` |
| `calculation_blocks.floor_2_load_bearing_walls.enabled` | `True` | `True` | `0` | `ok` |
| `calculation_blocks.floor_2_load_bearing_walls.floor_2_load_bearing_walls_enabled` | `True` | `True` | `0` | `ok` |
| `calculation_blocks.floor_2_load_bearing_walls.floor_2_masonry_volume_m3` | `13.5` | `13.5` | `0.0` | `ok` |
| `calculation_blocks.floor_2_load_bearing_walls.floor_2_adhesive_bags` | `18` | `18` | `0` | `ok` |
| `estimate_lines.floor_2_masonry_work.quantity` | `13.5` | `13.5` | `0.0` | `ok` |
| `estimate_lines.floor_2_masonry_work.work_total` | `94500` | `94500` | `0` | `ok` |
| `estimate_lines.floor_2_masonry_work.line_total` | `94500` | `94500` | `0` | `ok` |
| `estimate_lines.floor_2_gas_block_d400_material.quantity` | `15.05` | `15.05` | `0.0` | `ok` |
| `estimate_lines.floor_2_gas_block_d400_material.material_total` | `90300` | `90300` | `0` | `ok` |
| `estimate_lines.floor_2_gas_block_d400_material.line_total` | `90300` | `90300` | `0` | `ok` |
| `estimate_lines.floor_2_masonry_glue.quantity` | `18` | `18.0` | `0.0` | `ok` |
| `estimate_lines.floor_2_masonry_glue.material_total` | `6120` | `6120` | `0` | `ok` |
| `estimate_lines.floor_2_masonry_glue.line_total` | `6120` | `6120` | `0` | `ok` |
