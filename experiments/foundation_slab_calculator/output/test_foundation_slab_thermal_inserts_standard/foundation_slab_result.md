# Расчёт фундаментной плиты: test_foundation_slab_thermal_inserts_standard

Проект: `test_foundation_slab_thermal_inserts_standard`

## Входные параметры
- `project_name`: `test_foundation_slab_thermal_inserts_standard`
...
| `calculation_blocks.thermal_insert.thermal_insert_100_material_raw_qty` | `0.525` | `0.525` | `0.0` | `ok` |
| `calculation_blocks.thermal_insert.thermal_insert_50_material_purchase_qty` | `1.1104` | `1.1104` | `0.0` | `ok` |
| `calculation_blocks.thermal_insert.thermal_insert_100_material_purchase_qty` | `0.5552` | `0.5552` | `0.0` | `ok` |
| `estimate_lines.thermal_insert_50_installation.unit` | `мп` | `мп` | `` | `ok` |
| `estimate_lines.thermal_insert_50_installation.quantity` | `10` | `10.0` | `0.0` | `ok` |
| `estimate_lines.thermal_insert_50_installation.work_unit_price` | `100` | `100` | `0` | `ok` |
| `estimate_lines.thermal_insert_50_installation.work_total` | `1000` | `1000` | `0` | `ok` |
| `estimate_lines.thermal_insert_50_installation.line_total` | `1000` | `1000` | `0` | `ok` |
| `estimate_lines.thermal_insert_100_installation.unit` | `мп` | `мп` | `` | `ok` |
| `estimate_lines.thermal_insert_100_installation.quantity` | `15` | `15.0` | `0.0` | `ok` |
| `estimate_lines.thermal_insert_100_installation.work_unit_price` | `100` | `100` | `0` | `ok` |
