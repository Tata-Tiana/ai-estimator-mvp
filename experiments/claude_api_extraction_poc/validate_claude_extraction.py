...
def main() -> int:
    ...
    unit_guide_path = HERE / "pack" / "data" / "unit_normalization_guide.json"
    if not unit_guide_path.exists():
        unit_guide_path = HERE / "data" / "unit_normalization_guide.json"
    unit_guide = load_json(unit_guide_path)
