...
- стоимость прогона получилась хорошей для Opus: 0,87$ за два секционных фрагмента;
...
По цене вывод положительный: section-pack даёт возможность тестировать сильную модель точечно, не отправляя весь полный набор правил и targets каждый раз.
