# Расчёт монолитной плиты перекрытия 1-го этажа: test_floor_slab_1_no_beams

Проект: `synthetic_no_beams`

## Итоги
| Показатель | Значение |
| --- | ---: |
| `internal_materials_total` | `1131044` |
| `internal_works_total` | `576248` |
| `internal_section_total` | `1707292` |
| `base_subtotal_raw_before_overheads` | `1636820.624302` |
| `logistics_and_supply_total` | `16368` |
| `consumables_and_tool_depreciation_total` | `49105` |
...
| `geometry.slab_concrete_volume_m3_raw` | `40.53` |
| `geometry.slab_concrete_volume_m3_display` | `40.53` |
| `geometry.slab_formwork_area_m2` | `225.17` |
| `geometry.slab_control_geometry_area_m2` | `210.64` |
| `geometry.slab_edge_perimeter_m` | `118` |
| `geometry.edge_formwork_height_m` | `0.2` |
| `beams.items` | `[]` |
| `beams.total_length_m` | `0.0` |
| `beams.total_concrete_volume_m3` | `0.0` |
| `beams.total_formwork_area_m2` | `0.0` |
| `beams.concrete_volume_source` | `calculated_from_beam_items` |
| `beams.calculated_concrete_volume_m3` | `0.0` |
...
| `formwork.main_formwork_area_m2` | `225.166667` |
| `formwork.slab_formwork_area_m2` | `225.166667` |
| `formwork.edge_formwork_area_m2` | `23.6` |
| `formwork.beams_formwork_area_m2` | `0.0` |
| `formwork.edge_and_beam_formwork_area_m2` | `23.6` |
| `formwork.calculated_main_formwork_area_m2` | `225.166667` |
| `formwork.calculated_edge_formwork_area_m2` | `23.6` |
| `formwork.calculated_beams_formwork_area_m2` | `0.0` |
...
| `formwork.formwork_delivery_area_source_m2` | `225.166667` |
...
| `plywood_and_timber.edge_and_beam_plywood_sheets_raw` | `10.26087` |
| `plywood_and_timber.non_multiple_places_area_m2` | `45.033333` |
| `plywood_and_timber.non_multiple_places_plywood_sheets_raw` | `19.57971` |
| `plywood_and_timber.base_plywood_sheets_raw` | `29.84058` |
| `plywood_and_timber.order_plywood_sheets_raw` | `39.84058` |
| `plywood_and_timber.order_plywood_sheets` | `40` |
| `plywood_and_timber.overhang_sheet_equivalent` | `24.193478` |
| `plywood_and_timber.base_timber_volume_m3` | `1.18` |
| `plywood_and_timber.additional_timber_volume_m3` | `0.218866` |
| `plywood_and_timber.timber_volume_m3_raw` | `1.398866` |
...
| `overheads.base_subtotal_raw_before_overheads` | `1636820.624302` |
| `overheads.logistics_and_supply_percent` | `0.01` |
| `overheads.logistics_and_supply_total_raw` | `16368.206243` |
| `overheads.logistics_and_supply_total` | `16368` |
| `overheads.consumables_and_tool_percent` | `0.03` |
| `overheads.consumables_and_tool_depreciation_total_raw` | `49104.618729` |
| `overheads.consumables_and_tool_depreciation_total` | `49105` |
...
| `control_metrics.slab_area_used_in_estimate_m2` | `225.17` |
| `control_metrics.beam_concreting_control_total_by_length` | `0` |
...
| `main_formwork_area_m2` | `225.166667` |
| `slab_formwork_area_m2` | `225.166667` |
| `edge_formwork_area_m2` | `23.6` |
| `beams_formwork_area_m2` | `0.0` |
| `edge_and_beam_formwork_area_m2` | `23.6` |
| `calculated_main_formwork_area_m2` | `225.166667` |
| `calculated_edge_formwork_area_m2` | `23.6` |
| `calculated_beams_formwork_area_m2` | `0.0` |
...
| --- | --- | ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `slab_formwork_installation_control` | Монтаж опалубки под монолитное перекрытие 1-го этажа | `225.166667` | `225.166667` | `м2` | `zero_control_line` | `0.0` | `0` | `0.0` | `0` | `0.0` | `0` |
| `formwork_set_rental_material` | Комплект опалубки (телескопические стойки, унивилки, треноги, водостойкая фанера, поперечные и продольные балки двутавровые) | `225.166667` | `225.166667` | `м2` | `materials` | `135100.0002` | `135100` | `0.0` | `0` | `135100.0002` | `135100` |
...
| `formwork_consumables` | Расходные материалы для установки опалубки (смазка; звездочки ПВХ, трубки) | `1.0` | `1.0` | `-` | `materials_consumables` | `10582.833349` | `10583` | `0.0` | `0` | `10582.833349` | `10583` |
| `edge_beam_formwork_installation_control` | Монтаж опалубки из доски 50 мм и фанеры для устройства балок, для отбортовки плиты | `23.6` | `23.6` | `м2` | `zero_control_line` | `0.0` | `0` | `0.0` | `0` | `0.0` | `0` |
| `plywood_fk_18mm_for_edges_and_non_multiple_places` | Фанера ФК 1,52 * 1,52 толщиной 18 мм для закрытия некратных мест и торцов | `40.0` | `40.0` | `шт` | `materials` | `58000.0` | `58000` | `0.0` | `0` | `58000.0` | `58000` |
| `formwork_timber_gost` | Пиломатериал обрезной для устройства опалубки ГОСТ | `1.398866` | `1.4` | `м3` | `materials` | `30075.617753` | `30076` | `0.0` | `0` | `30075.617753` | `30076` |
...
| `floor_slab_concreting_work` | Бетонирование монолитной плиты перекрытия бетоном марки В22,5 (М300) | `40.53` | `40.53` | `м3` | `work` | `0.0` | `0` | `486360.0` | `486360` | `486360.0` | `486360` |
| `beam_concreting_work` | Бетонирование балки бетоном марки В22,5 (М300) | `0.0` | `0.0` | `м3` | `work` | `0.0` | `0` | `0.0` | `0` | `0.0` | `0` |
...
| `formwork_dismantling_zero_internal` | Демонтаж опалубки после завершения бетонирования | `225.166667` | `207.6` | `м2` | `client_only_zero_internal_line` | `0.0` | `0` | `0.0` | `0` | `0.0` | `0` |
...
| `logistics_and_supply` | Логистика, и снабжение | `1.0` | `1.0` | `-` | `materials_overhead_percent` | `16368.206243` | `16368` | `0.0` | `0` | `16368.206243` | `16368` |
| `consumables_tool_depreciation` | Расходные материалы, амортизация инструмента | `1.0` | `1.0` | `комплект` | `materials_overhead_percent` | `49104.618729` | `49105` | `0.0` | `0` | `49104.618729` | `49105` |
