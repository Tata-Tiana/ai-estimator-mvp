# Расчёт монолитной плиты перекрытия 1-го этажа: test_floor_slab_1_beams_concrete_volume_spec
...
| Показатель | Значение |
| --- | ---: |
| `internal_materials_total` | `1175636` |
| `internal_works_total` | `611848` |
| `internal_section_total` | `1787484` |
| `base_subtotal_raw_before_overheads` | `1713925.634713` |
| `logistics_and_supply_total` | `17139` |
| `consumables_and_tool_depreciation_total` | `51418` |
...
| `geometry.slab_concrete_volume_m3_raw` | `37.385` |
| `geometry.slab_concrete_volume_m3_display` | `37.39` |
| `geometry.slab_formwork_area_m2` | `207.69` |
...
| `beams.total_concrete_volume_m3` | `3.145` |
| `beams.total_formwork_area_m2` | `27.992` |
| `beams.concrete_volume_source` | `spec_beams_concrete_volume` |
| `beams.calculated_concrete_volume_m3` | `3.1548` |
| `beams.concrete_volume_delta_m3` | `-0.0098` |
...
| `formwork.main_formwork_area_m2` | `207.694444` |
| `formwork.slab_formwork_area_m2` | `207.694444` |
| `formwork.edge_formwork_area_m2` | `23.6` |
| `formwork.beams_formwork_area_m2` | `27.992` |
| `formwork.edge_and_beam_formwork_area_m2` | `51.592` |
| `formwork.calculated_main_formwork_area_m2` | `207.694444` |
...
| `formwork.formwork_delivery_area_source_m2` | `207.694444` |
...
| `formwork.raw_average_rate` | `589.4795413` |
...
| `formwork_rate_context.raw_average_rate` | `589.4795413` |
...
| `plywood_and_timber.non_multiple_places_area_m2` | `41.538889` |
| `plywood_and_timber.non_multiple_places_plywood_sheets_raw` | `18.060386` |
| `plywood_and_timber.base_plywood_sheets_raw` | `40.491691` |
| `plywood_and_timber.order_plywood_sheets_raw` | `50.491691` |
...
| `plywood_and_timber.additional_timber_volume_m3` | `0.211269` |
| `plywood_and_timber.timber_volume_m3_raw` | `2.790869` |
...
| `overheads.base_subtotal_raw_before_overheads` | `1713925.634713` |
| `overheads.logistics_and_supply_percent` | `0.01` |
| `overheads.logistics_and_supply_total_raw` | `17139.256347` |
| `overheads.logistics_and_supply_total` | `17139` |
| `overheads.consumables_and_tool_percent` | `0.03` |
| `overheads.consumables_and_tool_depreciation_total_raw` | `51417.769041` |
| `overheads.consumables_and_tool_depreciation_total` | `51418` |
...
| `control_metrics.slab_area_used_in_estimate_m2` | `207.69` |
...
| `main_formwork_area_m2` | `207.694444` |
| `slab_formwork_area_m2` | `207.694444` |
| `edge_formwork_area_m2` | `23.6` |
| `beams_formwork_area_m2` | `27.992` |
| `edge_and_beam_formwork_area_m2` | `51.592` |
| `calculated_main_formwork_area_m2` | `207.694444` |
...
| --- | --- | ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `slab_formwork_installation_control` | Монтаж опалубки под монолитное перекрытие 1-го этажа | `207.694444` | `207.694444` | `м2` | `zero_control_line` | `0.0` | `0` | `0.0` | `0` | `0.0` | `0` |
| `formwork_set_rental_material` | Комплект опалубки (телескопические стойки, унивилки, треноги, водостойкая фанера, поперечные и продольные балки двутавровые) | `207.694444` | `207.694444` | `м2` | `materials` | `124616.6664` | `124617` | `0.0` | `0` | `124616.6664` | `124617` |
...
| `formwork_consumables` | Расходные материалы для установки опалубки (смазка; звездочки ПВХ, трубки) | `1.0` | `1.0` | `-` | `materials_consumables` | `9761.638868` | `9762` | `0.0` | `0` | `9761.638868` | `9762` |
...
| `formwork_timber_gost` | Пиломатериал обрезной для устройства опалубки ГОСТ | `2.790869` | `2.79` | `м3` | `materials` | `60003.690445` | `60004` | `0.0` | `0` | `60003.690445` | `60004` |
...
| `floor_slab_concreting_work` | Бетонирование монолитной плиты перекрытия бетоном марки В22,5 (М300) | `37.385` | `37.39` | `м3` | `work` | `0.0` | `0` | `448620.0` | `448620` | `448620.0` | `448620` |
| `beam_concreting_work` | Бетонирование балки бетоном марки В22,5 (М300) | `3.145` | `3.15` | `м3` | `work` | `0.0` | `0` | `62900.0` | `62900` | `62900.0` | `62900` |
...
| `formwork_dismantling_zero_internal` | Демонтаж опалубки после завершения бетонирования | `207.694444` | `207.6` | `м2` | `client_only_zero_internal_line` | `0.0` | `0` | `0.0` | `0` | `0.0` | `0` |
...
| `logistics_and_supply` | Логистика, и снабжение | `1.0` | `1.0` | `-` | `materials_overhead_percent` | `17139.256347` | `17139` | `0.0` | `0` | `17139.256347` | `17139` |
| `consumables_tool_depreciation` | Расходные материалы, амортизация инструмента | `1.0` | `1.0` | `комплект` | `materials_overhead_percent` | `51417.769041` | `51418` | `0.0` | `0` | `51417.769041` | `51418` |
