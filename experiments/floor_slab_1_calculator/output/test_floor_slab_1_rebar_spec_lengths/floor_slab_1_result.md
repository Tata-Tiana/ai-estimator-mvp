...
| Показатель | Значение |
| --- | ---: |
| `internal_materials_total` | `1169386` |
| `internal_works_total` | `624099` |
| `internal_section_total` | `1793485` |
| `base_subtotal_raw_before_overheads` | `1719700.234518` |
| `logistics_and_supply_total` | `17197` |
| `consumables_and_tool_depreciation_total` | `51591` |
...
| `insulation.bottom_slab_eps_volume_m3` | `6.2436` |
| `insulation.bottom_slab_insulation_area_m2_raw` | `62.436` |
| `insulation.bottom_slab_eps_work_area_m2` | `62.436` |
...
| `overheads.base_subtotal_raw_before_overheads` | `1719700.234518` |
| `overheads.logistics_and_supply_percent` | `0.01` |
| `overheads.logistics_and_supply_total_raw` | `17197.002345` |
| `overheads.logistics_and_supply_total` | `17197` |
| `overheads.consumables_and_tool_percent` | `0.03` |
| `overheads.consumables_and_tool_depreciation_total_raw` | `51591.007036` |
| `overheads.consumables_and_tool_depreciation_total` | `51591` |
...
| `bottom_slab_eps_work_area_m2` | `62.436` |
...
| `logistics_and_supply` | Логистика, и снабжение | `1.0` | `1.0` | `-` | `materials_overhead_percent` | `17197.002345` | `17197` | `0.0` | `0` | `17197.002345` | `17197` |
| `consumables_tool_depreciation` | Расходные материалы, амортизация инструмента | `1.0` | `1.0` | `комплект` | `materials_overhead_percent` | `51591.007036` | `51591` | `0.0` | `0` | `51591.007036` | `51591` |
...
| --- | ---: | ---: | ---: | --- |
| `totals.internal_materials_total` | `1169386` | `1169386` | `0` | `ok` |
| `totals.internal_works_total` | `624099` | `624099` | `0` | `ok` |
| `totals.internal_section_total` | `1793485` | `1793485` | `0` | `ok` |
| `totals.base_subtotal_raw_before_overheads` | `1719700.234518` | `1719700.234518` | `0.0` | `ok` |
| `totals.logistics_and_supply_total` | `17197` | `17197` | `0` | `ok` |
| `totals.consumables_and_tool_depreciation_total` | `51591` | `51591` | `0` | `ok` |
