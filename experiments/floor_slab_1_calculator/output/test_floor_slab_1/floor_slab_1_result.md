# Расчёт монолитной плиты перекрытия 1-го этажа: test_floor_slab_1
...
| --- | ---: | ---: | ---: | --- |
| `totals.internal_materials_total` | `1175601` | `1175601` | `0` | `ok` |
| `totals.internal_works_total` | `611926` | `611926` | `0` | `ok` |
| `totals.internal_section_total` | `1787527` | `1787527` | `0` | `ok` |
