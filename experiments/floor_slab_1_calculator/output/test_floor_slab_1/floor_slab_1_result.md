...
| Показатель | Значение |
| --- | ---: |
| `internal_materials_total` | `1176087` |
| `internal_works_total` | `624099` |
| `internal_section_total` | `1800186` |
...
| --- | ---: | ---: | ---: | --- |
| `totals.internal_materials_total` | `1176087` | `1176087` | `0` | `ok` |
| `totals.internal_works_total` | `624099` | `624099` | `0` | `ok` |
| `totals.internal_section_total` | `1800186` | `1800186` | `0` | `ok` |
| `totals.base_subtotal_raw_before_overheads` | `1726141.700518` | `1726141.700518` | `0.0` | `ok` |
| `totals.logistics_and_supply_total` | `17261` | `17261` | `0` | `ok` |
| `totals.consumables_and_tool_depreciation_total` | `51784` | `51784` | `0` | `ok` |
...
| `calculation_blocks.insulation.total_insulation_length_m` | `108` | `84.8` | `-23.2` | `mismatch` |
| `calculation_blocks.insulation.edge_and_beam_insulation_area_m2` | `25.78` | `15.264` | `-10.516` | `mismatch` |
| `calculation_blocks.insulation.bottom_slab_insulation_area_m2_raw` | `51.92` | `62.436` | `10.516` | `mismatch` |
...
| `calculation_blocks.overheads.base_subtotal_raw_before_overheads` | `1726141.700518` | `1726141.700518` | `0.0` | `ok` |
| `calculation_blocks.overheads.logistics_and_supply_total` | `17261` | `17261` | `0` | `ok` |
| `calculation_blocks.overheads.consumables_and_tool_depreciation_total` | `51784` | `51784` | `0` | `ok` |
...
| `estimate_lines.beam_concreting_work.quantity_raw` | `7.0` | `7.0` | `0.0` | `ok` |
| `estimate_lines.beam_concreting_work.quantity_display` | `7.0` | `7.0` | `0.0` | `ok` |
| `estimate_lines.beam_concreting_work.material_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.beam_concreting_work.work_total` | `10500` | `10500` | `0` | `ok` |
| `estimate_lines.beam_concreting_work.line_total` | `10500` | `10500` | `0` | `ok` |
...
| `estimate_lines.formwork_dismantling_zero_internal.quantity_display` | `207.64` | `207.64` | `0.0` | `ok` |
...
| `estimate_lines.edge_beam_insulation_work.line_total` | `48600` | `38160` | `-10440` | `mismatch` |
| `estimate_lines.bottom_slab_insulation_work.quantity_raw` | `51.92` | `62.436` | `10.516` | `mismatch` |
| `estimate_lines.bottom_slab_insulation_work.quantity_display` | `62.44` | `62.44` | `0.0` | `ok` |
| `estimate_lines.bottom_slab_insulation_work.material_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.bottom_slab_insulation_work.work_total` | `46728` | `56192` | `9464` | `mismatch` |
| `estimate_lines.bottom_slab_insulation_work.line_total` | `46728` | `56192` | `9464` | `mismatch` |
...
| `estimate_lines.logistics_and_supply.material_total_raw` | `17261.417005` | `17261.417005` | `0.0` | `ok` |
| `estimate_lines.logistics_and_supply.material_total` | `17261` | `17261` | `0` | `ok` |
| `estimate_lines.logistics_and_supply.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.logistics_and_supply.line_total` | `17261` | `17261` | `0` | `ok` |
...
| `estimate_lines.consumables_tool_depreciation.material_total_raw` | `51784.251016` | `51784.251016` | `0.0` | `ok` |
| `estimate_lines.consumables_tool_depreciation.material_total` | `51784` | `51784` | `0` | `ok` |
| `estimate_lines.consumables_tool_depreciation.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.consumables_tool_depreciation.line_total` | `51784` | `51784` | `0` | `ok` |
