...
| Показатель | Значение |
| --- | ---: |
| `internal_materials_total` | `1151550` |
| `internal_works_total` | `582654` |
| `internal_section_total` | `1734204` |
| `base_subtotal_raw_before_overheads` | `1662696.700518` |
| `logistics_and_supply_total` | `16627` |
| `consumables_and_tool_depreciation_total` | `49881` |
...
| `overheads.base_subtotal_raw_before_overheads` | `1662696.700518` |
| `overheads.logistics_and_supply_percent` | `0.01` |
| `overheads.logistics_and_supply_total_raw` | `16626.967005` |
| `overheads.logistics_and_supply_total` | `16627` |
| `overheads.consumables_and_tool_percent` | `0.03` |
| `overheads.consumables_and_tool_depreciation_total_raw` | `49880.901016` |
| `overheads.consumables_and_tool_depreciation_total` | `49881` |
...
| `logistics_and_supply` | Логистика, и снабжение | `1.0` | `1.0` | `-` | `materials_overhead_percent` | `16626.967005` | `16627` | `0.0` | `0` | `16626.967005` | `16627` |
| `consumables_tool_depreciation` | Расходные материалы, амортизация инструмента | `1.0` | `1.0` | `комплект` | `materials_overhead_percent` | `49880.901016` | `49881` | `0.0` | `0` | `49880.901016` | `49881` |
...
| --- | ---: | ---: | ---: | --- |
| `totals.internal_materials_total` | `1151589` | `1151550` | `-39` | `mismatch` |
| `totals.internal_works_total` | `583630` | `582654` | `-976` | `mismatch` |
| `totals.internal_section_total` | `1735219` | `1734204` | `-1015` | `mismatch` |
| `totals.base_subtotal_raw_before_overheads` | `1663672.300518` | `1662696.700518` | `-975.6` | `mismatch` |
| `totals.logistics_and_supply_total` | `16637` | `16627` | `-10` | `mismatch` |
| `totals.consumables_and_tool_depreciation_total` | `49910` | `49881` | `-29` | `mismatch` |
...
| `calculation_blocks.overheads.base_subtotal_raw_before_overheads` | `1663672.300518` | `1662696.700518` | `-975.6` | `mismatch` |
| `calculation_blocks.overheads.logistics_and_supply_total` | `16637` | `16627` | `-10` | `mismatch` |
| `calculation_blocks.overheads.consumables_and_tool_depreciation_total` | `49910` | `49881` | `-29` | `mismatch` |
...
| `estimate_lines.logistics_and_supply.material_total_raw` | `16636.723005` | `16626.967005` | `-9.756` | `mismatch` |
| `estimate_lines.logistics_and_supply.material_total` | `16637` | `16627` | `-10` | `mismatch` |
| `estimate_lines.logistics_and_supply.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.logistics_and_supply.line_total` | `16637` | `16627` | `-10` | `mismatch` |
...
| `estimate_lines.consumables_tool_depreciation.material_total_raw` | `49910.169016` | `49880.901016` | `-29.268` | `mismatch` |
| `estimate_lines.consumables_tool_depreciation.material_total` | `49910` | `49881` | `-29` | `mismatch` |
| `estimate_lines.consumables_tool_depreciation.work_total` | `0` | `0` | `0` | `ok` |
| `estimate_lines.consumables_tool_depreciation.line_total` | `49910` | `49881` | `-29` | `mismatch` |
