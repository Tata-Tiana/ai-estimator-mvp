...
| Показатель | Значение |
| --- | ---: |
| `internal_materials_total` | `1052400` |
| `internal_works_total` | `522952` |
| `internal_section_total` | `1575352` |
| `base_subtotal_raw_before_overheads` | `1509952.846612` |
| `logistics_and_supply_total` | `15100` |
| `consumables_and_tool_depreciation_total` | `45299` |
...
| `overheads.base_subtotal_raw_before_overheads` | `1509952.846612` |
| `overheads.logistics_and_supply_percent` | `0.01` |
| `overheads.logistics_and_supply_total_raw` | `15099.528466` |
| `overheads.logistics_and_supply_total` | `15100` |
| `overheads.consumables_and_tool_percent` | `0.03` |
| `overheads.consumables_and_tool_depreciation_total_raw` | `45298.585398` |
| `overheads.consumables_and_tool_depreciation_total` | `45299` |
...
| `logistics_and_supply` | Логистика, и снабжение | `1.0` | `1.0` | `-` | `materials_overhead_percent` | `15099.528466` | `15100` | `0.0` | `0` | `15099.528466` | `15100` |
| `consumables_tool_depreciation` | Расходные материалы, амортизация инструмента | `1.0` | `1.0` | `комплект` | `materials_overhead_percent` | `45298.585398` | `45299` | `0.0` | `0` | `45298.585398` | `45299` |
