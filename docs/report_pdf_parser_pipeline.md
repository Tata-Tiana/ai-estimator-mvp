...
Этот слой теперь считается основным рабочим контуром для подготовки параметров из PDF. Более ранний `experiments/review_sheet_builder/` был промежуточной пробой и не должен использоваться как основной путь.
